...
interface PlaylistDao {
    ...
    @Query("SELECT medium_uri FROM playlist_medium_cross_entity WHERE playlist_id = :playlistId ORDER BY position ASC")
    fun getOrderedMediaUrisForPlaylist(playlistId: Long): Flow<List<String>>
